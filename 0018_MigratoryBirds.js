...
function main() {
    ...
    // var types = [ 1, 4, 4, 4, 5, 3 ];
    function toObject(types) {
      var typeOfBirds = {};
      for (var i = 0; i < types.length; i++)
        if(typeOfBirds[types[i]] === undefined){
      ...
      // console.log(typeOfBirds);
      return(Object.keys(typeOfBirds).reduce(function(a, b){
      if(typeOfBirds[a] > typeOfBirds[b] || typeOfBirds[a] === typeOfBirds[b]){
        return a
        }
        else {
          return b
